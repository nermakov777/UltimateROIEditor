...
{
    public class ShapeCreatorLine : ShapeCreator
    {
        public ShapeCreatorLine()
        { 
        ...
        { 
            ...
            UltimateLine urect = new UltimateLine(new Point(x, y), new Point(x+1, y+1));
